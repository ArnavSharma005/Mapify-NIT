...
function showDirections(startLat, startLng, endLat, endLng) {
    ...
    routingControl = L.Routing.control({
        ...
        createMarker: function(i, waypoint, n) {
            ...
            const isStart = i === 0;
            const iconUrl = isStart ? 'data:image/svg+xml;base64,' : 
